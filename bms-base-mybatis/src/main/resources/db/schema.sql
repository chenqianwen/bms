...
)COMMENT='系统用户' ENGINE = Innodb  CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
)COMMENT='系统角色' ENGINE = Innodb CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
)COMMENT='系统用户角色关系' ENGINE = Innodb CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_resource`  (
  ...
  `parent_id` varchar(64) COMMENT '上一层菜单主键',
  `previous_id` varchar(64) COMMENT '下一个同级资源主键',
  PRIMARY KEY (`id`) USING BTREE
)COMMENT='系统权限资源' ENGINE = Innodb CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
CREATE TABLE `dictionary`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
)COMMENT='数据字典' ENGINE = Innodb CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
